          ...
          <div className="lg:col-span-4">
            ...
            <ul className="space-y-4 text-sm text-primary-foreground/70">
              <li className="flex items-start gap-3">
                ...
                <a href="https://web.whatsapp.com/send?phone=447963345465" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">+44 7963 345465</a>
              </li>
              <li className="flex items-start gap-3">
