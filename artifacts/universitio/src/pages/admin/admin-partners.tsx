            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-border">
                  {items.map((item) => (
                    <tr key={item.id as number} onClick={() => navigate(`/admin/partners/${item.id}`)} className="hover:bg-muted/20 cursor-pointer transition-colors">
                      <td className="px-4 py-3 font-medium text-foreground">{item.fullName as string}</td>
                      <td className="px-4 py-3 text-muted-foreground hidden sm:table-cell">{item.organisation as string}</td>
                      <td className="px-4 py-3 text-muted-foreground hidden md:table-cell">{item.country as string}</td>
