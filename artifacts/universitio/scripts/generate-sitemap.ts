...
function generateSitemap(): string {
  ...
  urls.push(
    ...
    { loc: `${CANONICAL_URL}/askimate`, lastmod: "2026-03-24", changefreq: "weekly", priority: "0.90" },
    { loc: `${CANONICAL_URL}/services`, lastmod: "2026-03-24", changefreq: "monthly", priority: "0.90" },
