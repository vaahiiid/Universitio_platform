...
export default function AskiMateLogin() {
  ...
  const handleForgotSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`${import.meta.env.BASE_URL}api/askimate/auth/forgot-password`, {
        method: "POST",
      ...
      <div className="w-full max-w-md">
          ...
          {view === "login" && (
            <>
              <div className="space-y-3 mb-6">
                ...
                <Button variant="outline" size="lg" className="w-full" onClick={() => setLocation("/askimate-signup")}>
          ...
          {view === "forgot-sent" && (
            <div className="text-center space-y-4">
              ...
              <Button
                ...
                size="lg"
                className="w-full"
                onClick={() => { setView("login"); setForgotEmail(""); setError(""); }}
              >
                Back to Login
              </Button>
            </div>
        ...
        {view === "login" && (
          <p className="text-center text-sm text-muted-foreground mt-6">
            ...
            <button onClick={() => setLocation("/askimate-signup")} className="text-primary hover:underline font-medium">
              Sign up
            </button>
          </p>
        )}
